...
public class HomePageController implements Initializable {
    ...
    private ObservableList<Product> availableProducts = appServiceManager.getProductManager().getAvailableProductsForCustomer();
    ...
    public void initialize() {
        ...
        // Kiểm tra và khởi tạo availableProducts
        if (availableProducts == null) {
            System.err.println("availableProducts is null. Initializing empty list.");
            throw new IllegalStateException("Failed to initialize availableProducts from ProductManager");
        }
    ...
    private void handleLogin() {
        try {
            ...
            if (appServiceManager.getCurrentUser() != null) {
                ...
                if (currentUser instanceof Customer) {
                    applyAllFiltersAndSort(); // Cập nhật giao diện thay vì tải lại
                } else {
